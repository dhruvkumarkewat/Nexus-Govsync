...
export default function HowItWorks() {
  ...
  useEffect(() => { fetchContent('how-it-works', 'step').then(setSteps).catch(() => {}); }, []);

  return (
    <section id="how-it-works" ref={ref} className="relative bg-paper py-20 md:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-4">
            ...
            >
              Our AI-assisted interoperability layer understands, maps and connects systems—enabling secure data exchange and coordinated service delivery.
            </motion.p>
            <motion.button
